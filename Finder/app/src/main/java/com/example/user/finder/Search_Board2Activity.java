...
public class Search_Board2Activity extends AppCompatActivity {
    ImageView iv_board_lost;
    TextView tv_text_lost;

    String image;
    String text; // 글 내용
    String receiver; // 작성자 연락처
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_direct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alert = new AlertDialog.Builder(Search_Board2Activity.this);
        ...
        b_indirect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.setPositiveButton("전송", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        String message2 = "SWU파인더 알림!" +"\n" + "글 내용 : [" + text + "] \n"  +"습득자가 게시글을 확인했습니다. 분실물은 총학생회실에 맡겨집니다!";
