...
public class AlarmAdapter extends BaseAdapter {
    ...
    ArrayList<AlarmItem> alarmNum;
    ArrayList<AlarmItem> data;

    public AlarmAdapter(Context context, ArrayList<AlarmItem> data, ArrayList<AlarmItem> alarmNum, int layout) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.keywordView = (TextView)convertView.findViewById(R.id.tv_keyword);
        ...
        final AlarmItem item = data.get(position);
        final AlarmItem num = alarmNum.get(position);

        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    Log.e("deleteopenStream", num.keyword);
                    URL url = new URL(SERVER_ADDRESS + "/alarmDelete.php?"
                            + "alarmNum=" + num.keyword);
                    url.openStream();
                    String result = getXmlData("alarmDelete_result.xml", "result");
                    Log.e("result", result);
                ...
                listView = (ListView) parent.findViewById(R.id.keyword_list);
                AlarmAdapter adapter = new AlarmAdapter(context, data, alarmNum, R.layout.activity_mypage2_keyword);
        ...
        holder.keywordView.setText(item.keyword);
        holder.keywordView.setTextColor(Color.BLACK);
                ...
                while (eventType != XmlPullParser.END_DOCUMENT) {
                    if (eventType == XmlPullParser.START_DOCUMENT) {
                        ...
                        if (set == 1) {
                            ...
                            alarmNum.add(new AlarmItem(content));
                            Log.e("alarmNum", content);
                        }
                        else if (set == 3) {
                            data.add(new AlarmItem(content));
                            Log.e("data", content);
                        }
