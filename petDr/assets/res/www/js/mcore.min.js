...
/*! MDrawing Plugin 2.1.1.2 [Android 2.1.1.2, iOS 2.1.2.2] */
(function(b,c){var a="2.1.1.2";M.plugin("drawing",{create:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",userInterfaceType:"DEFAULT",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",donecb:"callback",uitype:"userInterfaceType",orient:"orientation",orientationType:"orientation",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},userInterfaceType:{DEFAULT:0,BUTTON:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;if(g.path){h.path=g.path}M.execute("wn2PluginDrawingCreate",h);return M},open:function(){var e,g,f=b,h={};e=M.defaultSetting.create({paramsKeys:["callback"],defaultSetting:{savePoint:"APPINSIDE",path:"",format:"PNG",privacy:false,orientation:"DEFAULT",callback:function(j,i){}},surrogateKeys:{alias:"path",source:"path",orient:"orientation",orientationType:"orientation",donecb:"callback",done:"callback",ondone:"callback",onsave:"callback"},enumsKeys:{savepoint:{APPINSIDE:0,APPOUTSIDE:1},format:{PNG:0,JPG:1},orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5}}});g=e.convert(arguments);var d=M.response.on(function(j,i){g.callback.call(f,j,i,g)});h.callback=d.toString();h.savePoint=g.savePoint;h.privacy=g.privacy===true?"YES":"NO";h.format=g.format;h.userInterfaceType=g.userInterfaceType;h.orientation=g.orientation;if(g.path===""&&M.media){M.media.library({media:"PHOTO",choose:"SINGLE"},function(j,i){if(j==="SUCCESS"){h.path=i.path;setTimeout(function(){M.execute("wn2PluginDrawingOpen",h)},500)}else{d.execute([])}})}else{h.path=g.path;M.execute("wn2PluginDrawingOpen",h)}return M}},a)})(window);

/*! MDocViewer Plugin 2.1.1.2 [Android 2.1.0.5, iOS 2.1.1.2]  */
(function(b,c){var a="2.1.1.2";M.plugin("viewer.doc",{gview:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["url","orientation","animation"],defaultSetting:{url:"",orientation:"DEFAULT",animation:"DEFAULT"},surrogateKeys:{orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.url==""){return{status:"FAIL",message:"fail to open google document viewer. because url is empty."}}h.url=g.url;h.orientation=g.orientation;h.animation=g.animation;d=M.execute("wn2PluginViewerDocOpenWithGoogleDocsViewer",h);return d},open:function(){var e,g,d,f=b,h={};e=M.defaultSetting.create({paramsKeys:["path","orientation","animation"],defaultSetting:{path:"",orientation:"DEFAULT",animation:"DEFAULT"},surrogateKeys:{alias:"path",source:"path",url:"path",orient:"orientation",orientationtype:"orientation",animate:"animation",animationtype:"animation"},enumsKeys:{orientation:{DEFAULT:0,PORT:1,PORTRAIT:1,LAND:2,LANDSCAPE:2,PORTREV:3,"PORT|REVERSE":3,"PORTRAIT|REVERSE":3,LANDREV:4,"LAND|REVERSE":4,"LANDSCAPE|REVERSE":4,ALL:5},animation:{DEFAULT:0,NONE:1,SLIDE_LEFT:2,SLIDE_RIGHT:3,SLIDE_TOP:4,SLIDE_BOTTOM:5,ZOOM_IN:6,ZOOM_OUT:7,FADE:8,MODAL_UP:9,MODAL_DOWN:10}}});g=e.convert(arguments);if(g.path==""){return{status:"FAIL",message:"fail to open document viewer. because path is empty."}}h.path=g.path;h.orientation=g.orientation;h.animation=g.animation;d=M.execute("wn2PluginViewerDocOpen",h);return d}},a)})(window);
